...
namespace RinkuApp.Persistence.Migrations
{
    ...
    [Migration("20221205043149_Agrego_Columna_SalarioBase_y_Bonos_a_tabla_A02Roles")]
    partial class AgregoColumnaSalarioBaseyBonosatablaA02Roles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RinkuApp.Persistence.Models.A02Roles", b =>
                {
                    ...
                    b.Property<string>("BonoXHora")
                        .IsRequired()
                        .HasMaxLength(300)
                        .HasColumnType("nvarchar(300)")
                        .HasColumnName("BonoXHora");
