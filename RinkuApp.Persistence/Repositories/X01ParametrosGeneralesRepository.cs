...
{
    public class X01ParametrosGeneralesRepository: IX01ParametrosGeneralesRepository
    {
        private readonly AppDbContext _context;

        public X01ParametrosGeneralesRepository(AppDbContext context)
        {
            _context = context;
        }
        ...
        {
            return _context.X01ParametrosGenerales.ToList();
        }
    }
}
